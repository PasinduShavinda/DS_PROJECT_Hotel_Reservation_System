...
export default class Shv_Update_Taxi_Reservations extends Component {
  ...
  onSubmit = (e) =>{
    ...
    axios.put(`http://localhost:8001/postTaxi/update/${id}`,data).then((res) =>{
      if(res.data.success){
    ...
    return (
      ...
      <div>
        ...
        <div>
          ...
          <center>
          <h1 className="h3 mb-3 font-weight-normal" style = {{backgroundColor:'cyan'}}><font face = "Comic sans MS" size ="6"><b>Update Taxi Reservation Details</b></font></h1><br/>&nbsp;
          </center>
          <br/>
          <center>
